export default function PrivacyPolicy() {
  return (
    <main className="mx-auto max-w-2xl px-6 py-12 text-[#3C424B] text-sm leading-relaxed">
      <h1 className="text-2xl font-bold text-[#181818] mb-6">Privacy Policy</h1>
      <p className="text-[#9BA3AE] mb-8">Last updated: April 4, 2026</p>

      <section className="mb-6">
        <h2 className="text-lg font-semibold text-[#181818] mb-2">1. Overview</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-[#181818] mb-2">2. Information We Collect</h2>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-[#181818] mb-2">3. How We Use Your Information</h2>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-[#181818] mb-2">4. Data Storage</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-[#181818] mb-2">5. Data Sharing</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-[#181818] mb-2">6. Your Rights</h2>
        <ul className="list-disc pl-5 space-y-1">
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-[#181818] mb-2">7. Children&apos;s Privacy</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-[#181818] mb-2">8. Changes to This Policy</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold text-[#181818] mb-2">9. Contact</h2>
        <p>
